 ...
 * HTML внутри (см. docs/adr/2026-07-02-twig-components.md, дополнение 2026-07-05). Тег и функция
 * с именем `component` сосуществуют — это разные пространства Twig ({% %} против выражения);
 * бестелые вызовы остаются на функции, слотовые идут через тег, оба в один renderComponent().
 *
...
final class ComponentTokenParser extends AbstractTokenParser
{
    ...
    private function splitSlots(Node $body, int $lineno): array
    {
        ...
        return [new Node($named, [], $lineno), $loose === [] ? null : new Node($loose, [], $lineno)];
    }
